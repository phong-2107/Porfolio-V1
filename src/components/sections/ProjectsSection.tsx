...
export default function ProjectsSection() {
  ...
  return (
    <section ref={sectionRef} id="projects" className="hero-section-panel section-3 relative z-20 w-full overflow-hidden">
      <div className="section-focal-wrapper w-full min-h-[100dvh] flex items-center justify-center px-6 py-32 md:px-12 lg:px-24">
